...
class AppotaCredit extends AppotaPayment{
    /**
     * return payment url
     * @Call $appotaCreditObj-> getPaymentUrl($developer_trans_id, $amount, $bank_id, $client_ip)
    ...
    public function getPaymentUrl($developer_trans_id, $amount, $bank_id = 0, $client_ip) {
        $api_url = $this->API_URL . $this->VERSION . '/' . $this->SANDBOX . '/services/pay_visa?api_key=' . $this->API_KEY . '&lang=' . $this->LANG;
